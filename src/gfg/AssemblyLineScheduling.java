...
public class AssemblyLineScheduling {
    //by default, there's two lines.
    public static int canAssembly(int[][] a, int[][] t, int[] e, int[] x) {
        ...
        return Math.min(T1[numStation - 1] + x[0], T2[numStation - 1] + x[1]);
    }
